...
def prepare_engine_extensions():
    ...
    # Engine exists here, but workers have not started yet. This is the only safe
    # composition point for cross-cutting event/decision/experience provenance: no HA
    # event or command can race ahead of the persistent command/context registry.
