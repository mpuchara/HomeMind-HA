...
from candidate_realtime_dashboard import install as install_candidate_realtime_dashboard
...
def prepare_engine_extensions():
    ...
    manager = install_candidate_realtime_dashboard(manager)
    core.STORE.event(
        ...
        "Candidate preference confidence and fast timing objective enabled",
        {
            ...
            "realtime_dashboard": getattr(manager, "candidate_realtime_dashboard_contract", None),
        },
    )
