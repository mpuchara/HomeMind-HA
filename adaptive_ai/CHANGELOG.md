...
- Rebuild schema-changed Candidate offline scoring from raw entity_history through SQLiteTemporalTracker + current policy.features, never legacy serialized feature indexes.
...
- Full suite contains 1082 tests.
