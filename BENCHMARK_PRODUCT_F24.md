...
| Mean inference cost on CI host | 0.0008 ms | 61.74 ms | 3.23 ms | 0.0008 ms |
...
GitHub Actions run `35437620477` validates the 0.14.34 agent-hot-path changes on the unchanged F24 v2 contract:
- Python 3.11: 932 tests, all passing;
- Python 3.13: 932 tests, all passing;
- compileall: passing;
