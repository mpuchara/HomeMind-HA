...
GitHub Actions run `35404551525` validates the 6-second OFF-confirmation runtime behavior before the release-metadata/version-only commit:
- Python 3.11: 891 tests, all passing;
- Python 3.13: 891 tests, all passing;
- compileall: passing;
