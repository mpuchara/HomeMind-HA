...
class Release012RequiredScenarios(unittest.TestCase):
    ...
    def test_prequential_sample_is_scored_before_learning(self):
        _run_existing(self, PrequentialReplayTests, "test_each_future_event_is_scored_before_learning") if False else _run_existing(self, PrequentialReplayTests, "test_each_future_event_is_scored_before_it_is_learned")
