...
'''
    ...
    def test_release_exposes_75ms_slice_control(self):
        ...
        self.assertIn('"training_max_continuous_work_ms": 75', settings)
        self.assertIn("DEFAULT_MAX_CONTINUOUS_WORK_MS = 75", runtime)
